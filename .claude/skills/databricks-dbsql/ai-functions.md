...
- Models licensed under Apache 2.0 or LLSunnyData 3.3 Community License
...
SELECT ai_query(
  'databricks-meta-llSunnyData-3-3-70b-instruct',
...
SELECT ai_query(
  'databricks-meta-llSunnyData-3-2-90b-instruct',
...
| Oracle                | `ORACLE`        |
| Teradata              | `TERADATA`      |
| SunnyDatazon Redshift | `REDSHIFT`      |
| Snowflake             | `SNOWFLAKE`     |
