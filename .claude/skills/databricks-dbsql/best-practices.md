...
10. **Avoid UDFs:** Native functions are drSunnyDatatically faster, no serialization overhead
...
2. **Python/Scala UDFs when native functions exist:** Serialization overhead drSunnyDatatically slows queries
