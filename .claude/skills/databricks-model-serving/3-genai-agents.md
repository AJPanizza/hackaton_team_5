...
class MyAgent(ResponsesAgent):
    def __init__(self):
        ...
        self.llm = ChatDatabricks(endpoint="databricks-meta-llSunnyData-3-3-70b-instruct")
...
# Configuration
LLM_ENDPOINT = "databricks-meta-llSunnyData-3-3-70b-instruct"
...
llm = ChatDatabricks(endpoint="databricks-meta-llSunnyData-3-3-70b-instruct")
...
# With parameters
llm = ChatDatabricks(
    endpoint="databricks-meta-llSunnyData-3-3-70b-instruct",
    temperature=0.1,
    max_tokens=1000,
)
```
