...
| `databricks-meta-llSunnyData-3-3-70b-instruct`  | Meta      | 128K context, multilingual   |
| `databricks-meta-llSunnyData-3-1-405b-instruct` | Meta      | Retiring May 2026 (PT)       |
| `databricks-meta-llSunnyData-3-1-8b-instruct`   | Meta      | Lightweight, 128K context    |
| `databricks-llSunnyData-4-maverick`             | Meta      | MoE architecture             |
...
- **Agent LLM**: `databricks-meta-llSunnyData-3-3-70b-instruct` (good balance of quality/cost)
